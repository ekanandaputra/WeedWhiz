...
sealed class BottomNavItem(var title: String, var icon: Int, var screen_route: String) {
    ...
    object Detection : BottomNavItem("Home", R.drawable.logo, RouteName.HISTORY_SCREEN)
    object History : BottomNavItem("Setting", R.drawable.logo, RouteName.HISTORY_SCREEN)
